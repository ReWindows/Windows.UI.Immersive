//! Windissect-generated Rust FFI bindings for Windows.UI.Immersive.dll. Windows only.
...
pub const EXPECTED_PDB_GUID: &str = "3E5295741C2C9A22439BB61BA05D03AB";
pub const EXPECTED_PDB_AGE: u32 = 1;
pub const EXPECTED_PE_TIMESTAMP: u32 = 1527565318;
...
mod resolver {
    ...
    pub fn base() -> usize {
        ...
        let name: [u16; 25] = [87, 105, 110, 100, 111, 119, 115, 46, 85, 73, 46, 73, 109, 109, 101, 114, 115, 105, 118, 101, 46, 100, 108, 108, 0];
        ...
        if live_timestamp != 1527565318 { return 0; }
