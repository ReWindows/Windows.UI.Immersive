// Flat C exports observed in Windows.UI.Immersive.dll. Unknown ABIs are intentionally not declared.
// Validated dialects: ISO C17/C23/C26 draft and Windissect C20 (C ABI under C++20).
#pragma once
#ifndef WINDOWS_UI_IMMERSIVE_C_H
#define WINDOWS_UI_IMMERSIVE_C_H
...
// Export: RegisterImmersiveBehaviors (ABI unverified)
// Export: #ordinal101 (ABI unverified)
// Export: UnregisterImmersiveBehaviors (ABI unverified)

#ifdef __cplusplus
} // extern "C"
#endif
#endif // WINDOWS_UI_IMMERSIVE_C_H
