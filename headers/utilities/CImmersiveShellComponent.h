...
public:
    ...
    // Symbol: ??0CImmersiveShellComponent@@QEAA@XZ
    CImmersiveShellComponent();
    ...
    // Category: Method | Source: PDB Internal
    // Symbol: ?RegisterServiceInformation@CImmersiveShellComponent@@QEAAJAEBU_GUID@@@Z
    long RegisterServiceInformation(_GUID const &);
    // Category: Method | Source: PDB Internal
